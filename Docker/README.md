...
查阅修改后使用 [docker-compose.yml](https://github.com/moomiji/docker-ddtv/blob/master/docker-compose.yml)。
...
可用镜像名: `moomiji/ddtv` `ghcr.io/moomiji/ddtv`。
...
docker run -d -p 8080:80 \
    ...
    -e show=false \
    --name DDTV_WEBUI moomiji/ddtvwebui
```
